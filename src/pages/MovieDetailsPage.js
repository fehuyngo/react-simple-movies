                        ...
                        {results?.slice(0,2).map(item => (
                            <div className='' key={item.id}>
                                ...
                                <div key={item.id} className='w-full aspect-video'>
                                    <iframe width="864" height="486" src={`https://www.youtube.com/embed/${item.key}`} 
                                    title="aespa 에스파 &#39;ep.3 Girls (Don’t you know I’m a Savage?)&#39; - SM Culture Universe" 
                                    frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                                    allowFullScreen className='w-full h-full object-fill'></iframe>
                                </div>
                            </div>
                        ))}
                    </div>
